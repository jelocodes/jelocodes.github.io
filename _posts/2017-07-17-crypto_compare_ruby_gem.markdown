...
So we can now scrape from our source page, get a list of the top 10 crypto currency names, and have a way to scrape the relevant attributes about specific crypto currencies if we pass in that crypto currency's name. 
